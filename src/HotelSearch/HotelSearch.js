	...
	loadGoogleMap() {
		...
		this.state.hotels.results.forEach((eachHotel, index) => {
			...
			const hotelInfo = `
									...
									<p style="font-size: 1.2em; font-weight:500"> <img src="https://static.thenounproject.com/png/18095-200.png" alt="price" style="width: 25px; height: 25px" /> ${eachHotel.min_price} ~ ${eachHotel.max_price}</p>
